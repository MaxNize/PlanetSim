...
3. Configure the following options:
   - **Domain Names**: Enter your DynDNS domain (e.g., `planet-sim.ipv64.net`).
   - **Scheme**: `http`
...
### 3. DynDNS Configuration (ipv64.net)

- Configure your home router to update your ipv64.net prefix on IP change.
- If using IPv6-only WAN, configure the IPv6-to-IPv4 mapping proxy on ipv64.net to route IPv4 client requests.
